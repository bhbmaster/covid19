...
covid_csv_merged='canada-merged.csv' ####### new for fixing canada-plot
...
pd_quick_info_maybe_save(c_merged, "MERGED DATA")
...
pd_quick_info_maybe_save(c_merged_mod_renamed, "MERGED_MOD DATA")
...
pd_quick_info_maybe_save(c_merged_mod_renamed_OTHER, "MERGED_MOD_OTHER")
