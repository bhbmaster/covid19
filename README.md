...
```bash
# main plot (all countries)
date; python3 covid19plot.py &> covid19plot.logerr; date; python3 covid19plot.py > covid19plot.logerr 2> covid19plot.err; date;

# usa-ca
cd usa-ca
date; python3 county-plot.py &> county-plot.logerr; date; python3 county-plot.py > county-plot.log 2> county-plot.err; date;

# usa-states
cd usa-states
date; python3 states-plot.py &> states-plot.logerr; date; python3 states-plot.py > states-plot.log 2> states-plot.err; date;

# canada
cd canada
date; python3 canada-plot.py &> canada-plot.logerr; date; python3 canada-plot.py > canada-plot.log 2> canada-plot.err; date;
```
...
- [ ] Add new graph called Deaths Per Cases (maybe... why did I want this again?).
