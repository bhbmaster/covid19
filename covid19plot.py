...
def divs2html(div_list,type_title,time_string,output_file,bootstrap_on=False):
    ...
    <body>
        ...
        <p>* <b>USA States Source:</b> The world data is gathered directly from <a href="https://github.com/nytimes/covid-19-data">NY Times</a> which generates a parsable <b><a href="https://github.com/nytimes/covid-19-data/blob/master/us-states.csv">csv</a></b> daily.</p>
